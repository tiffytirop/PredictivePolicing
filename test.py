...
crime16 = FileHandler.read_csv_file('sf_incidents16.csv')
crime17 = FileHandler.read_csv_file('sf_incidents17.csv')
...
#geting the map
sf = FileHandler.set_map_geometry('zipcodes_geo.json')
